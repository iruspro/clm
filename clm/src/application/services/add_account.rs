    ...
    AR: AccountRepository,
{
    ...
    pub fn execute(&self, cmd: Command) -> Result<AccountId, ServiceError> {
...
mod tests {
    ...
    fn sample_command(group_id: Option<AccountGroupId>) -> Command {
        Command {
    ...
    fn execute_stores_an_account_built_from_the_command() {
        ...
        let service = Service::new(SQLiteAccountRepository::new(&db));
