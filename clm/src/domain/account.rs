...
use crate::domain::ids::{AccountGroupId, AccountId};
...
/// [`AccountGroup`](crate::domain::account_group::AccountGroup).
#[derive(Debug, Clone)]
pub struct Account {
    id: AccountId,
    kind: AccountKind,
...
impl Account {
    ...
    /// type — build it via [`Name::new`](crate::domain::Name::new).
    pub fn new(
        id: AccountId,
        kind: AccountKind,
        currency: Currency,
    ...
    /// [`Name::new_unchecked`](crate::domain::Name::new_unchecked)) to skip re-checking.
