...
impl AccountGroup {
    ...
    /// its type — build it via [`Name::new`](crate::domain::Name::new).
    ...
    /// [`Name`] via [`Name::new_unchecked`](crate::domain::Name::new_unchecked) to skip
