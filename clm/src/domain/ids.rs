...
/// Unique identifier for an [`AccountGroup`](crate::domain::account_group::AccountGroup) (a time-ordered UUID v7).
...
/// Unique identifier for an [`Account`](crate::domain::account::Account) (a time-ordered UUID v7).
#[derive(Debug, Default, Clone, Copy, PartialEq, Eq, PartialOrd, Ord, Hash)]
...
/// Unique identifier for a [`Entry`](crate::domain::journal::Entry) (a time-ordered UUID v7).
#[derive(Debug, Default, Clone, Copy, PartialEq, Eq, PartialOrd, Ord, Hash)]
